...
$controller = new packc();
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $pack = $controller->getPackById($id);
    if (!$pack) {
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['update'])) {
        ...
        $date_d = $_POST['date_d'] ?? '';
        $updatedPack = new Pack($id, $titre, $description, $prix, $nombre_place, $date_d);
        if ($controller->updatePack($updatedPack)) {
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active bg-gradient-dark text-white" href="pack.php">
        ...
        <div class="col-lg-8 col-md-6 mb-md-0 mb-4 w-100">
          <div class="card">
            ...
            <div class="card-body px-0 pb-2">
                <form method="POST" action="updatepack.php?id=<?= htmlspecialchars($pack['id']); ?>">
                    <input type="hidden" name="id" value="<?= htmlspecialchars($pack['id']); ?>">

                    <label for="titre">Titre :</label><br>
                    <input type="text" id="titre" name="titre" value="<?= htmlspecialchars($pack['titre']); ?>" required><br>

                    <label for="description">Description :</label><br>
                    <textarea id="description" name="description" required><?= htmlspecialchars($pack['description']); ?></textarea><br>

                    <label for="prix">Prix (€) :</label><br>
                    <input type="number" id="prix" name="prix" value="<?= htmlspecialchars($pack['prix']); ?>" required><br>

                    <label for="nombre_place">Nombre de places :</label><br>
                    <input type="number" id="nombre_place" name="nombre_place" value="<?= htmlspecialchars($pack['nombre_places']); ?>" required><br><br>

                    <label for="date_d">Date  :</label><br>
                    <input type="date" id="date_d" name="date_d" value="<?= htmlspecialchars($pack['date_d']); ?>" required><br>
