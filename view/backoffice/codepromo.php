...
$list = $codePromoc->getAllCodePromos(); 
// Récupérer les statistiques des codes promo
$statusCounts = $codePromoc->getCountByStatus();
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
          ...
          <div class="card">
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive">
                ...
                <form method="post" action="export_codepromo_pdf.php">
                    <button type="submit" name="export_codepromo_pdf" class="btn btn-success">
                        Exporter Code Promo en PDF
                    </button>
                </form>
                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">reduction</th>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ID pack</th>
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                           <a href="deletecodep.php?id_code=<?= htmlspecialchars($codePromo['id_code']); ?>" class="btn btn-primary">
      ...
      <div class="container">
    <h1>Statistiques des Codes Promo</h1>
    <div class="row">
      <!-- Graphique Statut des Codes Promo -->
      <div class="col-md-6">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Statut des Codes Promo</h5>
            <canvas id="codePromoStatusChart"></canvas>
          </div>
        </div>
      </div>
    </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      var ctx = document.getElementById('codePromoStatusChart').getContext('2d');
      var codePromoStatusChart = new Chart(ctx, {
        type: 'pie',  // Utilisation d'un graphique circulaire
        data: {
          labels: ['Actifs', 'Non Actifs'],  // Labels pour Actif et Non Actif
          datasets: [{
            label: 'Nombre de Codes Promo',
            data: [<?= $activeCount ?>, <?= $inactiveCount ?>],  // Données dynamiques
            backgroundColor: ['#36a2eb', '#ff6384'],  // Couleurs distinctes pour Actif et Non Actif
            hoverOffset: 4
          }]
        },
        options: {
