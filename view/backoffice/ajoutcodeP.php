...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $codePromo = new CodePromo(null, $code, $reduction, $date_debut, $date_fin, $id_pack, $actif);
    $controller = new codePromoc();
    $success = $controller->addCodePromo($codePromo);
...
<head>
  ...
  <script>
    function validateForm() {
        ...
        if(code.length <= 2)
        {
          alert("le code promo doit avoir plus de 2 caracteres")
          return false;
        }
        const reduction = document.getElementById("reduction").value;
        if(reduction  == "")
        {
          alert("la reduction est requis")
          return false;
        }
        if(reduction  <= 5)
        {
          alert("doit avoir plus de 5% ")
          return false;
        }
        ...
        {
          alert("la date de debut ne peut pas etre apres la date fin ")
          return false;
        }
        return true;
    }
        ...
        <div class="col-lg-8 col-md-6 mb-md-0 mb-4">
          <div class="card">
            ...
            <div class="card-body px-0 pb-2">
              ...
              <form action="ajoutcodeP.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                  <label for="code">Code promo :</label><br>
                  <input type="text" id="code" name="code" ><br>
                  <label for="reduction">Réduction (%) :</label><br>
                  <input type="number" id="reduction" name="reduction" step="1" ><br>
                  ...
                  <select id="id_pack" name="id_pack" >
                      <option value="">Sélectionner un pack</option>
                      <?php foreach ($packs as $pack) { ?>
                          <option value="<?php echo $pack['id']; ?>">
                              <?php echo $pack['titre']; ?> - <?php echo $pack['prix']; ?>DT
                          </option>
                      <?php } ?>
                  </select><br>
                  <label for="actif">Actif :</label>
                  <input type="checkbox" id="actif" name="actif" value="1"><br><br>
                  <input type="submit" value="Ajouter Code Promo">
              </form>
            </div>
          </div>
        </div>
