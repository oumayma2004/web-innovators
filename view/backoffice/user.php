...
// Obtenir les comptes des rôles (admins et utilisateurs)
$roleCounts = $userc->getRoleCounts();
$adminsCount = $roleCounts['admins'];
$usersCount = $roleCounts['users'];
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg" style="background-image: url('img/back.jpeg'); background-size: cover; background-position: center;">
    ...
    <div class="container-fluid py-2">
      <div class="row">
        <div class="ms-3">
          <h3 class="mb-0 h4 font-weight-bolder">Dashboard User</h3>
        </div>
      </div>
    </div>  
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">changerole</th>
                  ...
                  <?php
                    ...
                    <tr>
                        ...
                        <div class="d-flex px-2 py-1">
                          <div>
                            <?php if (!empty($user['photo'])) { ?>
                              <img style="width: 50px; height: 50px;" src="<?= htmlspecialchars($user['photo']); ?>" alt="User Photo">
                            <?php } else { ?>
                              <span>No Photo</span>
                            <?php } ?>
                          </div>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> <?= htmlspecialchars($user['nom']); ?></span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> <?= htmlspecialchars($user['prenom']); ?></span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> <?= htmlspecialchars($user['email']); ?></span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> <?= htmlspecialchars($user['password']); ?></span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> <?= htmlspecialchars($user['adresse']); ?></span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> <?= htmlspecialchars($user['date_c']); ?></span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> <?= htmlspecialchars($user['phone']); ?></span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> <?= htmlspecialchars($user['role']); ?></span>
                      </td>
                      <td class="align-middle">
                           <a href="deleteuser.php?id=<?= htmlspecialchars($user['id']); ?>" class="btn btn-primary">
                          <i class="fa-solid fa-pen"></i> Delete
                        </a>
                      </td>
                      <td class="align-middle">
                           <a href="changerole.php?id=<?= htmlspecialchars($user['id']); ?>" class="btn btn-primary">
                          <i class="fa-solid fa-pen"></i> changerole
                        </a>
                     </td>
                     <td>
                          <!-- PDF Generation Form -->
    ...
    <!-- Submit button styled as a Bootstrap button -->
    <button type="submit" name="PDF" class="btn btn-primary">
        <i class="fa-solid fa-pen"></i> Télécharger PDF
    </button>
</form>
      ...
      <script>
          ...
          var roleChart = new Chart(ctx, {
              type: 'pie', // Type de graphique (ici, graphique circulaire)
              data: {
                  labels: ['Admins', 'Users'], // Les labels (admins et users)
                  datasets: [{
                      label: 'Nombre d\'utilisateurs par rôle',
                      data: [<?= $adminsCount ?>, <?= $usersCount ?>], // Les données dynamiques des rôles
                      backgroundColor: ['#36a2eb', '#ff6384'], // Couleurs du graphique
                      hoverOffset: 4
                  }]
              },
              options: {
    ...
    <div class="container mt-5">
        <!-- Statistiques des rôles sous forme de graphique -->
        <div class="row mb-4">
