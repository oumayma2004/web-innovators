...
<div class="form-container">
    <form id="eventForm" action="../addEvent.php" method="POST" enctype="multipart/form-data">
        ...
        <label>Status:</label>
        <select name="etat_e" id="etat_e">
            <option value="In stock">In stock</option>
            <option value="Sold out">Sold out</option>
        </select>
        <div class="error" id="etat_e_error"></div>
...
<script>
    ...
    function validateForm(event) {
        ...
        const etatE = document.getElementById('etat_e');
        ...
        // État
        if (etatE.value === "") {
            document.getElementById('etat_e_error').textContent = "Please select a status.";
            isValid = false;
        }
