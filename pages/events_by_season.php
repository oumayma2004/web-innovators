...
<head>
  ...
  <a class="nav-link text-dark" href="../pages/tables.php">
    ...
    <span class="nav-link-text ms-1">Tab_event</span>
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="../view/back/listreclamation.php">
            <i class="material-symbols-rounded opacity-5">view_in_ar</i>
            <span class="nav-link-text ms-1">Reclamation</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="../view/back/pages/liste_sponsors.php">
            <i class="material-symbols-rounded opacity-5">format_textdirection_r_to_l</i>
            <span class="nav-link-text ms-1">Sponsors</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="../view/back/pack.php">
            <i class="material-symbols-rounded opacity-5">notifications</i>
            <span class="nav-link-text ms-1">Packs</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="../view/back/user.php">
            <i class="material-symbols-rounded opacity-5">notifications</i>
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="../view/back/logout.php">
