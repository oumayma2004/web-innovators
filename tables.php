...
<head>
  ...
  <link rel="icon" width="200px" type="image/png" href="../assets/logo.jpg">
  <title>
    Dashboard 
  </title>
  <!--     Fonts and icons     -->
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center px-3">
              ...
              <table border="1">
    <tr>
        <th>ID</th><th>Nom</th><th>Lieu</th><th>Date début</th><th>Date fin</th><th>Prix</th><th>État</th><th>Catégorie</th><th>Description</th><th>Image</th><th>Action</th>
    </tr>
    ...
    <tr>
        ...
        <td>
            <form action="../view/deleteEvent.php" method="GET">
                <input type="hidden" name="id" value="<?= htmlspecialchars($event['id_event']) ?>">
